...
The StoreFront maintainers takes security seriously.
...
See [CODE_OF_CONDUCT.md](https://github.com/inacioferrarini/StoreFront/blob/master/CODE_OF_CONDUCT.md) for details.
